...
<!-- Mirrored from logovalley.co.uk/terms-and-conditions by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 13:18:42 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8">
<title>Terms and Conditions - logovalley</title>
...
<!--        <input type="hidden" id="location" name="SiteUrl" value="http://logovalley.co.uk/terms-and-conditions" />-->
...
<section class="sec-padding mtpx-60 trmswrp">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center">
        ...
        <p>Refund Policy will be Void if;</p>
            ...
            <ul>
                ...
                <li>  The creative brief is lacking in required information.
                <li>  A complete design change has been demanded.
          ...
          <h2>CONTENT CREATION & POPULATION</h2>
            ...
            <ul>
                <li>Our Customer Support Team is present in the office Monday - Friday 9 AM to 5 PM GMT to answer all of your concerns and queries over the phone. All other queries after business hours need to be emailed through BaseCamp section by the customer and will be picked up the next working day.</li>
            </ul>
            ...
            <ul>
                <li>   All Feedback requests or Revisions Requests, Refund Requests or any other instructions that pertain to the order need to be done through the BaseCamp platform/Emails in order to be considered official. </li>
                <li>   Bsepoke Logo will not be responsible for any communication done via any other platform than BaseCamp/Emails or any phone numbers not provided by us or given on our official website.</li>
            ...
            <h2>100% Satisfaction Guarantee</h2>
            <ul>
                <li>   We rework the ordered design and keep on revising it until you are 100% satisfied (depending upon your package).</li>
            </ul>
           <h2>Domain and Hosting</h2> 
           <ul>
               <li>    Domain and hosting will be provided for free with website packages, where applicable.</li>
               <li>    All the email accounts provided with website packages can be configured on third party email softwares such as outlook. Each email account will have 10MB of space.</li>
               <li>    If you are not hosting your website with us, we will not provide email accounts.</li>
           </ul>
           <h2>Delivery Policy</h2>
           <p>All design order files are delivered to My Account as per the date specified on the "Order Confirmation". An e-mail is also sent to inform the client about their design order delivery made to their specific account area. All policies pertaining to revision & refund are subject to date and time of design order delivered to client's account area. All design order files are delivered to "My Account" as per the date specified on the "Order Confirmation". An e-mail is also sent to inform the client about their design order delivery made to their specific account area. All policies pertaining to revision & refund are subject to date and time of design order delivered to client's account area. We deliver all our customised design orders via e-mail within 5 to 7 days of receiving your order. We offer a RUSH DELIVERY service through which you can have your first logo samples within 48 hours by paying just $100 extra! For further assistance, contact us at 24-Hour Customer Support Center.</p>
           <h2>Record Maintenance</h2>
           <p>We keep a record of your finalised design once we provide you the final files. <br>If you require the final files again in the future we can send them to you at your request.</p>
           <h2>Customer Support</h2>
                ...
                <div class="wrap">
                  ...
                  <div class="dtf text-left">
                    ...
                    <input type="hidden" name="cip" value="">
                     <input type="hidden" id="location" name="locationURL" value="terms-and-conditions.html">
                  </div>
                </div>
              </div>
            </form>
