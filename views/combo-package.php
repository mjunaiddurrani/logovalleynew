...
<!--            <p><span class="icon-quote-left"></span>FET has been with logovalley only for a few months, and the progress that FET has seen so far have outstretched any other SEO we have used in the past, FET will be having a long term relationship with logovalley.-->

<!--Just a couple of reason that we will be staying partners with logovalley is that I do not have to call them, they know what we need, and they get on with it.-->

<!--logovalley either email or regularly call to make sure that the stories that they are putting on to Facebook, Instagram and Linkedin are up to the standards that FET expect, and they are.-->

<!--Finally, I like to thank logovalley but especially Sabrina Williams for great work that she is doing.-->
...
<!--            <p><span class="icon-quote-left"></span>logovalley has been excellent taking a piece of work that's been messed up by another organisation and helping <span class="icon-quote-right"></span></p>-->
<!--            <div class="rating">-->
<!--              <i class="icon-star"></i>-->
<!--              <i class="icon-star"></i>-->
<!--              <i class="icon-star"></i>-->
