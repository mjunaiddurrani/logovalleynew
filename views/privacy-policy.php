...
<!-- Mirrored from logovalley.co.uk/privacy-policy by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 13:18:42 GMT -->
...
<section class="sec-padding mtpx-60">
  <div class="container">
    <div class="row">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <h3>Cookies</h3>
        <p>As you browse logovalley.co.uk, advertising cookies will be placed on your computer so that we can understand what you are interested in. Our display advertising partner, then enables us to present you with retargeting advertising on other sites based on your previous interaction with logovalley.co.uk. The techniques our partners employ do not collect personal information such as your name, email address, postal address or telephone number. You can visit this page to opt out of AdRoll and their partners’ targeted advertising.</p>
                ...
                <div class="wrap">
                  ...
                  <div class="dtf text-left">
                    ...
                    <input type="hidden" name="cip" value="">
                     <input type="hidden" id="location" name="locationURL" value="privacy-policy.html">
                  </div>
                </div>
              </div>
            </form>
