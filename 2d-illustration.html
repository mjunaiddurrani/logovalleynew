...
<!-- Mirrored from logovalley.co.uk/2d-illustration by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 13:18:26 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>Custom Illustration Agency For 2D and 3D Illustrations| Bespoke Logo</title>
<meta name="description" content="Bespoke Logo qualifies as a 2D illustration company and 3D illustration company. Get in touch with us for illustration projects."/>
<meta name="keywords" Custom Illustration Agency, 2D and 3D illustration company">
<link rel="canonical" href="2d-illustration.html"/>
...
<!--        <input type="hidden" id="location" name="SiteUrl" value="http://logovalley.co.uk/2d-illustration" />-->
...
<section class="inner-banner smm-banner d-flex seo" style="background-image: url(assets/images/banners/new/2d-3d-illustration.png);">
...
<section class="savingwrp">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="txtwrp">
          <h2>BeSpoke Logo Brings Your Illustration Ideas To Life</h2>
      ...
      <div class="col-lg-6">
        <div class="imgwrp">
          <img src="assets/images/services-inner/2d-3d-illustration.svg" alt="">
        </div>
      </div>
    </div>
  </div>
...
<section class="portfoliowrp">
 ...
 <div class="tab logodegn mytabs ">
    ...
    <div class="tab 2d mytabs current">
      <div class="row port-sliders">
      <div class="col-md-4">
...
<li  class="hightwrp">
  ...
  <a href="packages/infographics-writing.html" class="btn-detail">View Details</a>
        ...
        <ul class="tabs tabs-illust pkg-sliders current">    
          <li class="hightwrp">
  <div class="pack-wrap">
    <div class="hdarea">
      <!--<h4>Simple Start</h4>-->
              ...
              <div class="row">
                <div class="wrap">
                  ...
                  <div class="dtf text-left">
                    ...
                    <input type="hidden" name="pc" value="">
                    <input type="hidden" name="cip" value="">
                     <input type="hidden" id="location" name="locationURL" value="2d-illustration.html">
                  </div>
                </div>
              </div>
            </form>
...
<script>
    if(window.location.href.match('/seo')){$(".banner-from.seoform select[name='Services'] option:eq('4')").prop('selected', true);}
    if(window.location.href.match('/seo')){$(".bottom-form select[name='Services'] option:eq('4')").prop('selected', true);}
...
<!-- Mirrored from logovalley.co.uk/2d-illustration by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 13:18:27 GMT -->
</html>