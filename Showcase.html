...
<!-- Mirrored from logovalley.co.uk/Showcase by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 13:18:35 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>Showcase | BESPOKE LOGO</title>
...
<!--        <input type="hidden" id="location" name="SiteUrl" value="http://logovalley.co.uk/Showcase" />-->
...
<!--                  </script>-->
<!--                  <input type="hidden" name="hiddencapcha" value="">-->
<!--                  <input type="hidden" id="location" name="locationURL" value="http://logovalley.co.uk/Showcase" />-->
<!--               </div>-->
  ...
  <div class="container">
    <div class="row">
      ...
      <!--   <div class="test-wrap">
          ...
          <h3>"Our Business Grew 57% With The Marketing Services <br>By The Team At Bespoke Logo"</h3>
...
<div class="row testboxes">
    ...
    <div class="col-lg-4">
      <div class="box-wrap">
        <figure>
          <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/testbox1.png">
        </figure>
    ...
    <div class="col-lg-4">
      <div class="box-wrap">
        <figure>
          <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/testbox2.png">
        </figure>
    ...
    <div class="col-lg-4">
      <div class="box-wrap">
        <figure>
          <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/testbox3.png">
        </figure>
                ...
                <div class="wrap">
                  ...
                  <div class="dtf text-left">
                    ...
                    <input type="hidden" name="cip" value="">
                     <input type="hidden" id="location" name="locationURL" value="Showcase.html">
                  </div>
                </div>
              </div>
            </form>
...
<!-- Mirrored from logovalley.co.uk/Showcase by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 13:18:36 GMT -->
</html>