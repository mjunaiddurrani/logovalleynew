...
<!--        <input type="hidden" id="location" name="SiteUrl" value="http://logovalley.co.uk/video-animation" />-->
...
<section class="inner-banner smm-banner d-flex seo">
  <div class="container align-self-center">
    <div class="row">
      <div class="col-lg-7 col-xl-7">
        <div class="inner-banner-content">
          <h5>Best Logo Design Services in the UK</h5>
          <h2>Get A Great Video Made For Great Results</h2>
          <p class="custom-para">We impress your audience with 3D Animation Videos and Video Animation Services to help you stand a class apart from your competitors</p>
          <ul class="points">
              <li>Unique</li>
              <li>Creative</li>
              <li>Appropriate</li>
          ...
          <a href="javascript:;$zopim.livechat.window.show();" >Talk to our SEO Expert  </a><br/>
  ...
  <video class="mainvideo" autoplay loop muted playsinline preload="metadata">
                    ...
                    <source src="assets/video/background-video.html" type="video/ogg">
...
<section class="savingwrp">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="txtwrp">
          <h2>Video Animation Solutions Meeting Your Business Needs</h2>
          <p>we offer our work to introduce ourselves and take effective steps to attract the target audience. We are specialized in providing high-quality 2D and 3D animations to several national and foreign companies. We focus on creativity and quality and try not to make the "garden shadow" work! Yes, don't be surprised by us.
            <br>
We are well aware of the fierce competition between different video companies. Still, when it comes to creating unique, exciting and original videos, we are undoubtedly a "toast of the town".
      ...
      <div class="col-lg-6">
        <div class="imgwrp">
          <img src="assets/images/contact-side.gif" alt="">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="tab videoani mytabs">
      ...
      <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/1.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-1.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
       <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/2.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-2.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
       <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/3.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-3.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
       <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/4.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-4.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
       <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/5.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-5.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
       <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/6.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-6.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
       <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/7.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-7.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
       <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/8.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-8.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
       <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/9.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-9.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
          <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/10.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-10.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
          <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/11.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-11.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
          <div class="col-md-4">
              <a class="ss-portfolio__item" data-fancybox href="assets/images/portfolio/video-animation/inner/12.mp4">
                <figure class="ss-portfolio__item--image"> 
                    <img class=" img-fluid lazy" 
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/portfolio/video-animation/thumbnail/t-12.webp" alt="*"/> 
                </figure>
            </a> 
      </div>
    ...
    <div class="row">
      <div class="col-md-12 nopad_left nopad_right">
        ...
        <ul class="tabbing-links">
          ...
          <li class="current" data-targetit="tabs-video">Video</li>
          <li data-targetit="tabs-illust">2D Illustration </li>
        </ul>
...
<li class="hightwrp">
  ...
  <a href="packages/3d-advance-animation.html" class="btn-detail">View Details</a>
        ...
        <ul class="tabs tabs-video current pkg-sliders">    
          <li class="hightwrp">
  <div class="pack-wrap">
    <div class="hdarea">
      <h4>Simple Start</h4>
      <h3>Startup Video Packages</h3>
      <p>Suitable for potential super-startups and brand revamps for companies.</p>
...
<li class="hightwrp">
  <div class="pack-wrap">
    ...
    <div class="ftarea">
      <div class="lft">
        <h4><!-- <span class="cutting_price">£500</span> --><strong>£</strong>1,499.00</h4>
      </div>
      <div class="rht">
        <p>Add on: $500 for expedited services</p>
      </div>
...
<li class="hightwrp">
  <div class="pack-wrap">
    <div class="hdarea">
      <h4>Simple Start</h4>
      <h3>Unlimited Video Packages</h3>
      <p>Suitable for potential super-startups and brand revamps for companies.</p>
    ...
    <div class="ftarea">
      <div class="lft">
        <h4><!-- <span class="cutting_price">£500</span> --><strong>£</strong>2,299.00</h4>
      </div>
      <div class="rht">
        <p>Add on: $500 for expedited services</p>
      </div>
...
<section class="strugglesec">
  <div class="container">
    <div class="row">
      <h2>Animation that gives you real benefits</h2>

      <div class="col-lg-8 offset-lg-2">
        <ul>
          <li>Appealing Animations</li>
          <li>Catchy Scripts</li>
          <li>Extensive Choice of Voiceovers</li>
          <li>Personalized Animated Characters</li>
          <li>Minimal Turnaround Time</li>
          <li>2D Animation </li>
          <li>3D Animation</li>
        </ul>
              ...
              <div class="row">
                <div class="wrap">
                  ...
                  <div class="dtf text-left">
                    ...
                    <input type="hidden" name="pc" value="">
                    <input type="hidden" name="cip" value="">
                     <input type="hidden" id="location" name="locationURL" value="video-animation.html">
                  </div>
                </div>
              </div>
            </form>
...
<!-- Mirrored from logovalley.co.uk/video-animation by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 13:18:45 GMT -->
</html>