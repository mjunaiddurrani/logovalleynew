   ...
   <div class="main_nav">
        <div class="container">   
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand logo" href="index.php" data-aos="fade-down" data-aos-duration="1000"> <img class="img-fluid" src="assets/images/logo.png" alt="" style="max-width: 30%;"> </a>
				...
				<div class="cardInfo">
					<div class="card myCardPay" >
						<div class="card-header text-center text-black">
							<h2 class="card-heading">Invoice from LogoValley</h2>
						...
						<div class="p-4"> 
							...
							<tr>
								...
								<td><b><?php echo $symbol.' '.$amount?></b></td>
							</tr>
							<tr>
